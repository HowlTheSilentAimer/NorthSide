...
getgenv().Aiming = {
    ...
    TargetPart = {"Head", "LowerTorso", "UpperTorso", "RightUpperArm", "LeftUpperArm", "RightLowerArm", "LeftLowerArm", "RightUpperLeg", "LeftUpperLeg", "LeftLowerLeg", "RightLowerLeg", "RightFoot", "LeftFoot", "RightShoulder", "LeftShoulder",},
